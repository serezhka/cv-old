...
\cvline{}{My main direction - Java development\newline
    Enthusiastic, eager to explore new technologies,\newline
    quickly assimilate new concepts and ideas}
...
\cvline{Java}{JEE, Spring, AspectJ, JUnit, PowerMock}
\cvline{Front-end}{jQuery, AJAX, Bootstrap}
\cvline{Database}{MySQL, H2}
\cvline{Others}{Maven, Tomcat, SonarQube, Node.js}

\section{Computer skills}
\cvline{IDE/Editors}{IntelliJ IDEA, Eclipse, Web Storm}
